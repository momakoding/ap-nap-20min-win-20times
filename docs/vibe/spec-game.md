...
玩家扮演主角 **Tonald Dump**。游戏总长 120 秒现实时间（对应游戏内 20 分钟）。

* **健康值 (health)**：初始 40，上限 100。降至 0 时触发“彻底气炸/心脏停摆”结局。
* **外交声誉 (diplomacy)**：初始 60，上限 100。降至 0 时触发“被踢出群聊”结局。
* **压力值 (stress)**：初始 30，上限 100。代替原焦虑指数。压力过高时会引发健康值加速扣减，达到 100 时直接摔手机破防。
...
| --- | --- | --- | --- | --- |
| **炫口麦当劳金拱门** | 30秒 | +30 | +10 | 补充高盐高脂的快乐能量，高呼：没人比我更懂优质蛋白质！ |
| **高尔夫挥杆拉伸** | 18秒 | +18 | -5 | 在休息室里无球挥杆，舒展腰椎，假装自己正置身于佛州阳光沙滩。 |
| **对空气打军体拳** | 9秒 | +10 | -10 | 狂暴挥拳，宣泄情绪，用强有力的核心力量证明自己还能再干八年。 |
...
| **密室狂发推特宣泄** | 12秒 | +12 | -25 | 疯狂敲击屏幕，把所有批判多边主义的废话发出去，念头瞬间通达。 |
...
* **条件：成功推迟或处理完全部 12 个打断事件，且游戏未提前结束**
